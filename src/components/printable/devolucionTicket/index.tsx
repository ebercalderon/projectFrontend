        ...
        <div className="flex flex-col gap-4 items-center bg-white rounded-2xl w-full h-auto text-xs" ref={ref}>
            <div className="w-full h-5/6 rounded-3xl bg-white z-10 ">
                <div className="flex flex-col gap-1">
                    <h2 className="text-xl font-semibold text-center ">{NombreTienda || "SISTEMA Web"}</h2>
                    ...
                    {props.devolucion.ventaOriginal.numFactura && <div className="text-center">Num. factura: {props.devolucion.ventaOriginal.numFactura}</div>}
