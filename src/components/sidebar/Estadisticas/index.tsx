        ...
        <div className="flex flex-col gap-4 h-full w-full bg-white rounded-b-2xl rounded-r-2xl p-4 shadow-lg border-x overflow-y-scroll">
            ...
            </div>
            {
                ...
                <div className="flex flex-wrap gap-2 justify-start xl:justify-center">
                    ...
                    <div className="xl:w-72 w-44">
                        <FinanceCard titulo="Efectivo" unidad="S/" dataActual={summary?.totalEfectivo?.toFixed(2)} dataPrevio={summary?.totalEfectivo?.toFixed(2)} />
                    </div>
                    <div className="xl:w-72 w-44">
                        <FinanceCard titulo="Tarjeta" unidad="S/" dataActual={summary?.totalTarjeta?.toFixed(2)} dataPrevio={summary?.totalTarjeta?.toFixed(2)} />
                    </div>
                    <div className="xl:w-72 w-44">
                    ...
                    <div className="xl:w-72 w-44">
                        <FinanceCard titulo="Media" unidad="S/" dataActual={summary?.mediaVentas?.toFixed(2)} dataPrevio={summary?.mediaVentas?.toFixed(2)} />
                    </div>
                    <div className="xl:w-72 w-44">
                        <FinanceCard titulo="Máxima" unidad="S/" dataActual={summary?.ventaMaxima?.toFixed(2)} dataPrevio={summary?.ventaMaxima?.toFixed(2)} />
                    </div>
                    <div className="xl:w-72 w-44">
                        <FinanceCard titulo="Mínima" unidad="S/" dataActual={summary?.ventaMinima?.toFixed(2)} dataPrevio={summary?.ventaMinima?.toFixed(2)} />
                    </div>
                    {/* <div className="xl:w-72 w-44">
