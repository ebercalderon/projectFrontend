            ...
            </div>
            {
                ...
                <div className="flex flex-wrap gap-2 justify-start xl:justify-center">
                    <div className="xl:w-72 w-44">
                        <FinanceCard titulo="Ventas" unidad="" dataActual={summary?.totalVentas.toFixed(2)} dataPrevio={summary?.totalVentas.toFixed(2)} />
                    </div>
                    <div className="xl:w-72 w-44">
                    ...
                    <div className="xl:w-72 w-44">
                        <FinanceCard titulo="Beneficio" unidad="" dataActual={summary?.beneficio.toFixed(2)} dataPrevio={summary?.beneficio.toFixed(2)} />
                    </div>
                    <div className="xl:w-72 w-44">
